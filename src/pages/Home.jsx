...
export const Home = () => {
  ...
  return (
    <>
      <img src="https://les3fromages.com/wp-content/uploads/2022/04/LOGO_3F_2021web.png" className="h-100 w-300 flex justify-center" alt="Les 3 Fromages" title="LOGO_3F_2021web" data-src="https://les3fromages.com/wp-content/uploads/2022/04/LOGO_3F_2021web.png" />
      <h1 className='text-white text-4xl font-bold flex justify-center py-10'>
        Bienvenue au concert des 3 Fromages !
      </h1>
      <div className='text-white text-justify font-semibold flex flex-col pb-12 text-2xl'>
      <p className='flex justify-center pb-1'>
        Pour l'occasion, nous vous proposons un concours de selfie.
        </p>
        <p className='flex justify-center pb-1'>
        Afin de participer, rien de plus simple entre ton e-mail, prends-toi en photo et envoie le
        </p>
        <p className='flex justify-center'>
        Un tirage au sort sera réalisé et tu recevras un e-mail pour t'informer du résultat.
      </p>
      </div>
      <form className="flex flex-col justify-center" onSubmit={handleSubmit(saveEmailToDatabase)}>
